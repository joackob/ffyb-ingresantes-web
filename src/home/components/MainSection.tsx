      ...
      <Container>
        ...
        >
          ...
          <Box
            gridArea={"img"}
            sx={{
              backgroundImage: `url("https://images.vexels.com/media/users/3/242551/isolated/preview/3b3e399c4a66074557004b3faa2d9ba1-elementos-de-pegatinas-de-regreso-a-la-escuela-5.png")`,
