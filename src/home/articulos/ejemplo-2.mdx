...
<iframe
  width="693"
  height="390"
  src="https://www.youtube.com/embed/aYqVCCIvX1Q"
  title="LA RULETA DECIDE DONDE PASAMOS LA PRIMERA NOCHE EN LA NUEVA MANSIÓN"
  frameBorder="0"
...
const MiComponente = () => (
  <div>
    ...
    <p>
      Este es un ejemplo de cómo se puede integrar un componente React en un
      archivo MDX.
    </p>
  </div>
);
